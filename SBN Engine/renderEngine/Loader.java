...
public class Loader {
	...
	public RawModel loadToVAO(float[] position,float[] textureCoords,float[] normal,int[] indices) {
		int vaoID = createVAO();
	...
	public int loadToVAO(float[] position,float[] textureCoords) {
		int vaoID = createVAO();
	...
	public RawModel loadToVAO(float[] position) { // GUI
		int vaoID = createVAO();
		storeDataInAttributeList(0, 2, position);
		unbindVAO();
